(module
 ...
 (data (i32.const 688) "Goal is not exist or already closed\00")
 (data (i32.const 736) "Permlink is not a valid size.\00")
 (data (i32.const 768) "Invalid permlink character\00")
